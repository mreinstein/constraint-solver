...
function peg$parse(input, options) {
  ...
  var peg$consts = [
    ...
    /^[\t\v\f \xA0\uFEFF]/,
    peg$classExpectation(["\t", "\v", "\f", " ", "\xA0", "\uFEFF"], false, false),
    /^[\n\r\u2028\u2029]/,
  ...
  var peg$bytecode = [
    peg$decode("%;//A#$;!0#*;!&/1$;//($8#: #!!)(#'#(\"'#&'#"),
    peg$decode("%;//k#;A/b$$;%0#*;%&/R$$;@0#*;@&/B$$;%0#*;%&/2$;(/)$8&:!&\"$\")(&'#(%'#($'#(#'#(\"'#&'#.\xA1 &%;//\x97#;?/\x8E$$;%/&#0#*;%&&&#/x$;4/o$%$;%/&#0#*;%&&&#/,#;@/#$+\")(\"'#&'#.\" &\"/A$$;%0#*;%&/1$;(/($8':\"'!#)(''#(&'#(%'#($'#(#'#(\"'#&'#"),
    peg$decode("1\"\"5!7#"),
    ...
    peg$decode("%%;1/2#2G\"\"6G7H/#$+\")(\"'#&'#/K#$4*\"\"5!7+/,#0)*4*\"\"5!7+&&&#/)$8\":I\"\"! )(\"'#&'#"),
    peg$decode("%4J\"\"5!7K.\" &\"/E#$4*\"\"5!7+/,#0)*4*\"\"5!7+&&&#/#$+\")(\"'#&'#"),
    peg$decode("<%;5/' 8!:M!! )=.\" 7L"),
    peg$decode("<%;#/9#$;$0#*;$&/)$8\":N\"\"! )(\"'#&'#=.\" 7L"),
    peg$decode("%;4/' 8!:O!! ).h &;0.b &%2P\"\"6P7Q/R#;//I$;A/@$;//7$2R\"\"6R7S/($8%:T%!\")(%'#($'#(#'#(\"'#&'#"),
    ...
    peg$decode("3k\"\"5(7l"),
    peg$decode("3m\"\"5(7n.A &3o\"\"5&7p.5 &3q\"\"5&7r.) &3s\"\"5$7t"),
    peg$decode("%;=/\x8F#$%;//D#2u\"\"6u7v/5$;//,$;=/#$+$)($'#(#'#(\"'#&'#0N*%;//D#2u\"\"6u7v/5$;//,$;=/#$+$)($'#(#'#(\"'#&'#&/)$8\":w\"\"! )(\"'#&'#")
  ];
